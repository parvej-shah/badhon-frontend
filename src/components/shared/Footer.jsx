      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <h2 className="text-3xl mb-6 font-black mr-1">
            <span className="text-primary">Bad</span>hon
          </h2>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to receive campaings and the latest updates about health.
            </p>
            <div className="flex">
              <input
                type="email"
        ...
        <p className="mb-2 text-gray-400">© 2024 Badhon. All Rights Reserved.</p>
          <p>Designed and Developed by Parvej Shah & Saikat Islam | Student of IIT, DU</p>
        </div>
      </footer>
    );
  };
